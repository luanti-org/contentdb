...
You can send ContentDB a DMCA notice by email to
<a href="mailto:{{ admin_contact_email }}">{{ admin_contact_email }}</a>.

DMCA notices can only be submitted by the copyright owner or an authorized agent.
...
2. Identification of the material that is claimed to be infringing, reasonably
   sufficient to permit us to locate the material.
3. Your contact information (for example, email address, address, telephone).
4. A statement that you have a good faith belief that use of the material in the
